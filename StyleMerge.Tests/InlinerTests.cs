...
namespace StyleMerge.Tests
{
    ...
    public class InlinerTests
    {
        ...
        [InlineData("ShouldConvertColorRGBToHex")]
        ...
        [InlineData("ShouldHandleBoxSizing")]
        [InlineData("ShouldNotApplyStylesToHead")]
        [InlineData("ShouldNotConvertTransparentColorRGBAToHex")]
        [InlineData("ShouldPreserveHexColor")]
        [InlineData("ShouldPreserveHexColorInline")]
        [InlineData("ShouldPreserveRootSelector")]
        [InlineData("ShouldPreserveDeprecatedWordBreakInline")]
        [InlineData("ShouldPreserveTransparentBackgroundColor")]
        [InlineData("ShouldPreserveTransparentBackgroundColorInline")]
